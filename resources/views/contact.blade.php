...
<main>
			<div class="container-fluid px-0">
				...
				<div class="parallax-window parallax-window-2" data-parallax="scroll" data-image-src="{{asset('assets/img/contact-2.jpg')}}"></div>

				<div class="mx-auto tm-content-container mt-4 px-3 mb-3">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-page-title mb-5 tm-text-primary">Testimonies</h2>    
                        </div>                        
                    </div>
					<div class="row">
		                <div class="col-lg-6 mb-5 pt-3">
		                    <div class="media tm-testimonial">
                                <img class="mr-4 rounded-circle img-fluid" src="{{asset('assets/img/testimonial-1.jpg')}}" alt="Generic placeholder image">
		                ...
		                <div class="col-lg-6 mb-5 pt-3">
                              <div class="media tm-testimonial">
                              <img class="mr-4 rounded-circle img-fluid" src="{{asset('assets/img/testimonial-2.jpg')}}" alt="Generic placeholder image">
                              <p class="media-body pt-3 tm-testimonial-text">
                        ...
                        <div class="col-lg-6 mb-5 pt-3">
                            <div class="media tm-testimonial">
                              <img class="mr-4 rounded-circle img-fluid" src="{{asset('assets/img/testimonial-3.png')}}" alt="Generic placeholder image">
                              <p class="media-body pt-3 tm-testimonial-text">
                        ...
                        <div class="col-lg-6 mb-5 pt-3">
                            <div class="media tm-testimonial">
                              <img class="mr-4 rounded-circle img-fluid" src="{{asset('assets/img/testimonial-4.png')}}" alt="Generic placeholder image">
                              <p class="media-body pt-3 tm-testimonial-text">
