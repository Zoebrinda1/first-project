	...
	<div class="tm-page-wrap mx-auto">
					...
					<div class="row">						
                        <div class="col-7 col-md-4">
                            <a href="index.html" class="tm-bg-black text-center tm-logo-container">
                                ...
                                <h1 class="tm-site-name">Event Catalog</h1>
                            </a>
                        </div>
                                ...
                                <nav class="navbar navbar-expand-lg mr-0 ml-auto" id="tm-main-nav">
                                    ...
                                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                                        <ul class="navbar-nav text-uppercase">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link tm-nav-link" href="inscription.html">Inscription</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
        ...
        <div class="container-fluid tm-content-container mx-auto pt-5">
            ...
            <footer class="row pt-5">
                <div class="col-12">
                    <p class="text-right">Copyright 2021 The Event Catalog Company 
                        
                        - Designed by Zoe<!-- <a href="https://templatemo.com" rel="nofollow" target="_parent">TemplateMo</a> --></p>
                </div>
            </footer>
